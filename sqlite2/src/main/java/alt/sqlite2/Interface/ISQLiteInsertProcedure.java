...
/**
 * Created by lawrence on 7/25/15.
 */
public interface ISQLiteInsertProcedure {
    ...
    long executeInsert(String tableName,ContentValues contentValues);
    long[] executeJoinTableInsert(long fkentity1Id,JoinTable[] joinTables);
